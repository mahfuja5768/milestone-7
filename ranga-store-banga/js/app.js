...
const showProductDetailsInModal = (product_details) => {
   ...
   setInnerValue('exampleModalLabel', product_details.title);
   setInnerValue('productId', product_details.id);
   setInnerValue('modal_body', product_details.description);
   setInnerValue('rating', product_details.rating.rate);
};
